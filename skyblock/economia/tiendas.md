...
Si prefieres vender directamente a otros jugadores sin pasar por la subasta, puedes montar tu propia tienda física en tu isla.
...
3. Define si es una tienda de **compra** o de **venta** y establece el precio.
...
{% hint style="info" %}
Para ventas rápidas sin montar una tienda, también puedes usar la [Subasta](README.md) o el [Intercambio Directo](README.md).
{% endhint %}
